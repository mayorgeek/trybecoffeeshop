    ...
    <body>
        ...
        <header class="header">
            ...
            <nav class="navbar navbar-expand-lg">
                    <ul class="navbar-nav mr-auto nav" style="display: flex; justify-content: center;">
                        <li class="nav-item">
        ...
        <section class="home" id="home">
            <div class="content">
                <h3>Welcome to Trybe Coffee Shop, mga kap!</h3>
                <p>
        ...
        <section class="about" id="about">
            ...
            <div class="row g-0">
                ...
                <div class="content">
                    <h3>trybe coffee shop!</h3>
                    <p>
                        At Trybe Coffee Shop, we are passionate about coffee and believe
                    ...
                    <p>
                        ...
                        inviting atmosphere at Trybe is designed to be a haven
        ...
        <section class="footer">
            <div class="footer-container">
                ...
                <div class="credit">
                    <hr /><br/>
                    <h2>Trybe Coffee © 2024 | All Rights Reserved.</h2>
